...
// 	}
	...
	///////20131115
	if (m_str_axis_name == "X" || m_str_axis_name == "Vision X" || m_str_axis_name == "Attach X" || m_str_axis_name == "Reject X" || m_str_axis_name == "Vision X" || m_str_axis_name == "Bottom X" || m_str_axis_name == "Top X" || m_str_axis_name == "Top LD 2" || m_str_axis_name == "Bottom ULD 2")
	{
		m_btn_left.SetIcon(IDI_LEFT);
	}
	else if(m_str_axis_name == "Top LD 1" || m_str_axis_name == "Bottom ULD 1")
	{
		m_btn_left.SetIcon( IDI_RIGHT );
	}
	else if (m_str_axis_name == "Rolling 1" || m_str_axis_name == "Rolling 2" || m_str_axis_name == "Attach Y" || m_str_axis_name == "Robot Y" || m_str_axis_name == "EL")
	{
		m_btn_left.SetIcon(IDI_DN);
	}
	else if (m_str_axis_name == "Attach Z1" || m_str_axis_name == "Attach Z2" || m_str_axis_name == "Robot Z" || m_str_axis_name == "Stacker Z" || m_str_axis_name == "Attach 1 Z1" || m_str_axis_name == "Attach 1 Z2"   || m_str_axis_name == "Attach 2 Z1" || m_str_axis_name == "Attach 2 Z2")
	{
		m_btn_left.SetIcon(IDI_UP);
	}
	else if (m_str_axis_name == "CV Pitch" || m_str_axis_name == "Attach 1 R1" || m_str_axis_name == "Attach 1 R2" || m_str_axis_name == "Attach 2 R1" || m_str_axis_name == "Attach 2 R2" || m_str_axis_name == "Attach 1 X" || m_str_axis_name == "Attach 2 X")
	{
		m_btn_left.SetIcon(IDI_DN);
	}
	else if (m_str_axis_name == "Pusher" || m_str_axis_name == "Feeder1" || m_str_axis_name == "Feeder2" || m_str_axis_name == "Feeder3" || m_str_axis_name == "Feeder4")
	{
		m_btn_left.SetIcon(IDI_DN);
	}
...
void CDialog_Motor_Axis_1::MotorStatusCheck()
{
	...
	if (m_n_home == 0)
	{
		if (m_n_sd == 1)
		{
			if (m_n_minus_el == 1)
			{
				...
				{
					m_p_grid.GridCellColor(gridMotInfo, 2, 1, RED_C, WHITE_C);
				}
				else
				{
			...
			{
				m_p_grid.GridCellColor(gridMotInfo, 2, 3, RED_C, WHITE_C);
			}
			else
			{
			...
			if (m_n_plus_el == 1)
			{
				...
				{
					m_p_grid.GridCellColor(gridMotInfo, 2, 5, RED_C, WHITE_C);
				}
				else
				{
		...
		else
		{
			...
			if (m_n_plus_el == 1)
			{
				if (COMI.Get_MotIOSensor(m_n_axis, MOT_SENS_ELP) == CTLBD_RET_GOOD)
				{
					m_p_grid.GridCellColor(gridMotInfo, 2, 4, RED_C, WHITE_C);
				}
				else
				{
	...
	{
		m_p_grid.GridCellColor(gridMotInfo, 4, 1, RED_C, WHITE_C);
	}
	else
	{
